    ...
    t = {
        ...
        cols: [[
           ...
           /* {field:'id',        title: 'ID'   },*/
            ...
            {field:'createDate',  title: '创建时间',    width:'14%',templet:'<div>{{ layui.laytpl.toDateString(d.createDate.replace(/-/g,"/")) }}</div>',unresize: true}, //单元格内容水平居中
            {field:'updateDate',  title: '修改时间',    width:'14%',templet:'<div>{{ layui.laytpl.toDateString(d.updateDate.replace(/-/g,"/")) }}</div>',unresize: true}, //单元格内容水平居中
