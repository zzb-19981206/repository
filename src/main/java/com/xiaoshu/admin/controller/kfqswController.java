...
@RestController
@RequestMapping("admin/kfqsw/res")
public class kfqswController {
...
//		test.setQuerymc(user.getLoginName());
		...
		List<Slxx> list = shMainSwService.kfqbdcswList(test);
